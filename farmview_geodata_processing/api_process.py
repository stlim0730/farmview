...
# Takes in FormData model.
def create_sync_table(form_data):
    download_ona_data(form_data.ona_id)
    ...
    form_data.import_id, form_data.dropbox_url = res['id'], db_url
    form_data.save()
...
# using survey data id (curr=63362) and change the formats to geoJSON
...
# not sure how to retrieve public url after sharing
